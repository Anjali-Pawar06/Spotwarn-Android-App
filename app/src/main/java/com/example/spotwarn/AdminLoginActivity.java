        ...
        tvForgotPassword.setOnClickListener(v -> {
            ...
            auth.sendPasswordResetEmail(email)
                    .addOnSuccessListener(aVoid ->
                            Toast.makeText(AdminLoginActivity.this, "Reset Link sent to your Email", Toast.LENGTH_LONG).show()
                    )
    ...
    private void loginUser() {
        ...
        auth.signInWithEmailAndPassword(email, password)
                .addOnSuccessListener(authResult -> {
                    ...
                    startActivity(new Intent(AdminLoginActivity.this, PoliceDashboardActivity.class));
                    finish();
                })
                .addOnFailureListener(e ->
                        Toast.makeText(AdminLoginActivity.this, "Login Failed: " + e.getMessage(), Toast.LENGTH_LONG).show()
                );
    }
